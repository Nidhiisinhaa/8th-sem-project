...
export default function Login({ onLogin }) {
  ...
  if (role === 'teacher') {
    ...
    // ── STUDENT LOGIN/SIGNUP (dummy mode until backend is ready) ──
    // const userData = {
...
//           //   throw new Error(responseJson.message || "Signup failed");
//           // }
//           // const userData = { name: responseJson.student?.name || name.trim(), role };
//           // ---- END BACKEND BLOCK ----

//           // ---- DUMMY MODE (delete when student backend is ready) ----
...
//           //   throw new Error(responseJson.message || "Login failed");
//           // }
//           // const userData = { name: responseJson.student?.name || email.split('@')[0], role };
//           // ---- END BACKEND BLOCK ----
